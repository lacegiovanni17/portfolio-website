...
function BackgroundCircles({}: Props) {
  return (
      <motion.div
          ...
          <div className='absolute rounded-full border-[#333333] rounded-full h-[500px] w-[500px] mt-52 animate-ping'/>
          <div className='absolute rounded-full border border-[#F7AB0A] opacity-20 h-[650px] w-[650px] mt-52 animate-pulse'/>
          <div className='absolute rounded-full border border-[#F7AB0A] opacity-20 h-[800px] w-[800px] mt-52'/>
    </motion.div>
  )
}
